...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/access_link/:token/consume", middleware.CriticalRateLimit(), controller.ConsumeUserAccessLink)
			...
			adminRoute.Use(middleware.AdminAuth(), middleware.AdminAudit())
			{
				...
				adminRoute.POST("/:id/access_link", controller.GenerateUserAccessLink)
		...
		r2sRoute := apiRouter.Group("/r2s")
		r2sRoute.Use(middleware.AdminAuth(), middleware.AdminAudit())
		{
			...
			r2sRoute.PUT("/channel-bindings/:id", controller.UpdateR2SChannelBinding)
			r2sRoute.DELETE("/channel-bindings/:id", controller.DisableR2SChannelBinding)
			r2sRoute.GET("/payments", controller.GetR2SPayments)
			r2sRoute.POST("/payments", controller.CreateR2SPayment)
