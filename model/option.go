...
func InitOptionMap() {
	...
	common.OptionMap["RequireUserDisplayNameEnabled"] = strconv.FormatBool(common.RequireUserDisplayNameEnabled)
	common.OptionMap["RequireUserEmailBindingEnabled"] = strconv.FormatBool(common.RequireUserEmailBindingEnabled)
	...
	common.OptionMap["UserGroupUsageLimits"] = setting.UserGroupUsageLimits2JSONString()
	common.OptionMap["UserUsageLimitMultiplierRules"] = setting.UserUsageLimitMultiplierRules2JSONString()
	common.OptionMap["ModelRatio"] = ratio_setting.ModelRatio2JSONString()
	common.OptionMap["ModelPrice"] = ratio_setting.ModelPrice2JSONString()
	common.OptionMap["CacheRatio"] = ratio_setting.CacheRatio2JSONString()
	common.OptionMap["GroupRatio"] = ratio_setting.GroupRatio2JSONString()
	common.OptionMap["GroupCaptureRate"] = ratio_setting.GroupCaptureRate2JSONString()
	...
	common.OptionMap[R2SReceiptRequiredOptionKey] = "false"
	common.OptionMap[R2SDefaultCurrencyCodeOptionKey] = ""
	common.OptionMap[R2SBalanceReminderDaysOptionKey] = "30"
	//common.OptionMap["ChatLink"] = common.ChatLink
	//common.OptionMap["ChatLink2"] = common.ChatLink2
	common.OptionMap["QuotaPerUnit"] = strconv.FormatFloat(common.QuotaPerUnit, 'f', -1, 64)
	common.OptionMap["RetryTimes"] = strconv.Itoa(common.RetryTimes)
	common.OptionMap["GlobalWebSessionVersion"] = strconv.Itoa(common.GlobalWebSessionVersion)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" {
		...
		case "RequireUserDisplayNameEnabled":
			common.RequireUserDisplayNameEnabled = boolValue
		case "RequireUserEmailBindingEnabled":
			common.RequireUserEmailBindingEnabled = boolValue
	...
	case "UserGroupUsageLimits":
		err = setting.UpdateUserGroupUsageLimitsByJSONString(value)
	case "UserUsageLimitMultiplierRules":
		err = setting.UpdateUserUsageLimitMultiplierRulesByJSONString(value)
	case "RetryTimes":
		common.RetryTimes, _ = strconv.Atoi(value)
	case "GlobalWebSessionVersion":
		common.GlobalWebSessionVersion, _ = strconv.Atoi(value)
	...
	case "GroupCaptureRate":
		err = ratio_setting.UpdateGroupCaptureRateByJSONString(value)
